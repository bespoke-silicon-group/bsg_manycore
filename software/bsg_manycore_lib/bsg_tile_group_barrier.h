...
static void inline poll_range( int range, unsigned char *p);
//------------------------------------------------------------------
//b. send alert to all of the tiles in the row 
static void inline alert_row ( bsg_row_barrier * p_row_b);
//------------------------------------------------------------------
//c. send alert to all of the tiles in the col 
static void inline alert_col ( bsg_col_barrier * p_col_b);
...
static void inline bsg_row_barrier_sync(bsg_row_barrier * p_row_b, int center_x_cord ){
        int  i;
...
static void inline bsg_col_barrier_sync(bsg_row_barrier * p_row_b, bsg_col_barrier * p_col_b, int center_x_cord, int center_y_cord ){
        int i;
...
static void inline bsg_col_barrier_alert(  bsg_col_barrier *  p_col_b ) {
...
//   executed only by the tiles at the center of the row
static void inline bsg_row_barrier_alert(  bsg_row_barrier *  p_row_b, bsg_col_barrier * p_col_b ){
        int i;
        int x_range = p_row_b-> _x_cord_end - p_row_b->_x_cord_start;
...
//------------------------------------------------------------------
static void inline bsg_tile_wait(bsg_row_barrier * p_row_b){
...
//------------------------------------------------------------------
static void bsg_tile_group_barrier(bsg_row_barrier *p_row_b, bsg_col_barrier * p_col_b){
