...
class BloodGraph:
  ...
  def __init__(self, start_time, end_time, timestep, abstract):
    ...
    self.stalls_list   = {"stall_depend",
                          ...
                          "stall_depend_remote_darm_load",
                          "stall_depend_remote_global_load",
                          "stall_depend_remote_group_load",
                          "stall_depend_remote_unknown_load",
                          "stall_depend_local_remote_dram_load",
                          "stall_depend_local_remote_global_load",
                          "stall_depend_local_remote_group_load",
                          "stall_depend_local_remote_unknown_load",
                          "stall_fp_local_load",
                          "stall_fp_remote_dram_load",
                          "stall_fp_remote_global_load",
                          "stall_fp_remote_group_load",
                          "stall_fp_remote_unknown_load",
                          "stall_force_wb",
                          "stall_ifetch_wait",
                          "stall_icache_store",
                          "stall_lr_aq",
    ...
    self.detailed_stall_bubble_color = { "stall_depend"                           : (0xff, 0xff, 0xff), ## white
                                         ...
                                         "stall_depend_remote_dram_load"          : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_remote_global_load"        : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_remote_group_load"         : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_remote_unknown_load"       : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_local_remote_dram_load"    : (0x00, 0xcc, 0xcc), ## dark cyan
                                         "stall_depend_local_remote_global_load"  : (0x00, 0xcc, 0xcc), ## dark cyan
                                         "stall_depend_local_remote_group_load"   : (0x00, 0xcc, 0xcc), ## dark cyan
                                         "stall_depend_local_remote_unknown_load" : (0x00, 0xcc, 0xcc), ## dark cyan
                                         "stall_fp_local_load"                    : (0x66, 0x00, 0x66), ## dark puprle
                                         "stall_fp_remote_dram_load"              : (0xcc, 0x00, 0xcc), ## purple
                                         "stall_fp_remote_global_load"            : (0xcc, 0x00, 0xcc), ## purple
                                         "stall_fp_remote_group_load"             : (0xcc, 0x00, 0xcc), ## purple
                                         "stall_fp_remote_unknown_load"           : (0xcc, 0x00, 0xcc), ## purple
    ...
    self.abstract_stall_bubble_color = { "stall_depend"                           : (0xff, 0xff, 0xff), ## white 
                                         ...
                                         "stall_depend_remote_group_load"         : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_remote_unknown_load"       : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_local_remote_dram_load"    : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_local_remote_global_load"  : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_local_remote_group_load"   : (0x00, 0xff, 0x00), ## green
                                         "stall_depend_local_remote_unknown_load" : (0x00, 0xff, 0x00), ## green
                                         "stall_fp_local_load"                    : (0xff, 0xff, 0xff), ## white
                                         "stall_fp_remote_dram_load"              : (0x00, 0xff, 0x00), ## green
                                         "stall_fp_remote_global_load"            : (0x00, 0xff, 0x00), ## green
                                         "stall_fp_remote_group_load"             : (0x00, 0xff, 0x00), ## green
                                         "stall_fp_remote_unknown_load"           : (0x00, 0xff, 0x00), ## green
