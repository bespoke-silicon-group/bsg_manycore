...
int main()
{
  ...
  int bsg_global_x = __bsg_grp_org_x + bsg_x;
  int bsg_global_y = __bsg_grp_org_y + bsg_y;

  bsg_mcs_mutex_node_t lcl, *lcl_as_glbl = (bsg_mcs_mutex_node_t*)bsg_global_pod_ptr(0,0,bsg_global_x,bsg_global_y,&lcl);
