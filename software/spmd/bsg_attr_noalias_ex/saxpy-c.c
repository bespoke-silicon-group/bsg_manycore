...
/*
 * saxpy_c_noalias: With bsg_attr_noalias, the code "guarantees" that stores to
 * C do not affect A and B so load/store instructions can be reordered because
 * the pointers do not alias.
 *
 * The disassembly and compiler flags are shown in snippets/saxpy_c_noalias.md
 *
 */
 ...
 * The disassembly and compiler flags are shown in snippets/saxpy_c_noalias_A.md, 
 * snippets/saxpy_c_A_noalias.md, and snippets/saxpy_c_noalias_noalias.md
 */
 ...
 * elements long.
 *
 * saxpy_c_noalias_flat result: Loads and stores are reordered. If flattening
 ...
 * index variable.
 *
 * The disassembly and compiler flags are shown in snippets/saxpy_c_noalias_flat.md
 */
 ...
 * saxpy_c_inline result: Inlining discards bsg_attr_noalias qualifiers, if the
 * caller does not have bsg_attr_noalias qualifiers. Loads and stores are not
 * reordered
 *
 * The disassembly and compiler flags are shown in snippets/saxpy_c_inline.md
 */
void saxpy_c_inline(float * A, float * B, float * C, float alpha) {
        saxpy_c_noalias(A, B, C, alpha);
}
