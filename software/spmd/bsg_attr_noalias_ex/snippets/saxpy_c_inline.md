...
00000004 <.L39>:
  ...
  1c:	70f57043          	fmadd.s	f0,f10,f15,f14
  ...
  3c:	101571c3          	fmadd.s	f3,f10,f1,f2
  ...
  5c:	28457343          	fmadd.s	f6,f10,f4,f5
  ...
  7c:	58757643          	fmadd.s	f12,f10,f7,f11
        for(int i = 0;  i < N_ELS; ++i) {
  80:	80078813          	addi	x16,x15,-2048
                C[i] = alpha * A[i] + B[i];
  84:	00c8a027          	fsw	f12,0(x17)
        for(int i = 0;  i < N_ELS; ++i) {
  88:	f6081ee3          	bnez	x16,4 <.L39>
